...
////////////////////////////////////////////////////////////////////////////////////////////////////
// TextBuffer: Static variables
////////////////////////////////////////////////////////////////////////////////////////////////////

TextBuffer* TextBuffer::instance = nullptr;
...
{   // {{{
    ...
    // Memorize the created instance.
    if (TextBuffer::instance == nullptr)
        TextBuffer::instance = this;
...
{   // {{{
    ...
    if (TextBuffer::instance == this)
        TextBuffer::instance = nullptr;
