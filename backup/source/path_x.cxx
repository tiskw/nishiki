...
PathX::listdir(uint32_t n_max_items) const noexcept
{   // {{{
    ...
    const std::string target_str = replace(target.string(), "~", getenv("HOME"));
    ...
    constexpr auto sort_key_func = [](const std::string& s1, const std::string& s2) noexcept -> bool
    {
