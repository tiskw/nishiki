...
#
# NOTE: This config file is written in Python, but it is PocketPy not CPython.
#       Therefore the available standard library is very limited. See the
#       <https://pocketpy.dev/> for the details of PocketPy.
################################################################################
